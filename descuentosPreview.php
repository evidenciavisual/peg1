...
//------------------------------------------------
if (file_exists('src/xml/descuentosDesc.xml')) {
	$file= file_get_contents('src/xml/descuentosDesc.xml');
	...
	file_put_contents("src/xml/descuentos3.xml", $file);
    $xml = simplexml_load_file('src/xml/descuentos3.xml');
    //var_dump($xml);
//------------------------------------------------
// FIN CARGA XML
//------------------------------------------------
