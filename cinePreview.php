...
//------------------------------------------------
if (file_exists('src/xml/cineDesc.xml')) {
	$file= file_get_contents('src/xml/cineDesc.xml');
	...
	file_put_contents("src/xml/cine3.xml", $file);

    $xml = simplexml_load_file('src/xml/cine3.xml');
//------------------------------------------------
// FIN CARGA XML
//------------------------------------------------
    ?>
